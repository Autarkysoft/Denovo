...
namespace Tests.Bitcoin.P2PNetwork.Messages.MessagePayloads
{
    public class AddrPayloadTests
    {
        ...
        private readonly NetworkAddressWithTime addr1 =
            new NetworkAddressWithTime(NodeServiceFlags.NodeNetwork, IPAddress.Parse("192.0.2.51"), 8333, 1414012889);
        private readonly NetworkAddressWithTime addr2 =
            new NetworkAddressWithTime(NodeServiceFlags.NodeXThin | NodeServiceFlags.NodeWitness, IPAddress.Parse("123.45.67.89"), 9823, 1581412378);
