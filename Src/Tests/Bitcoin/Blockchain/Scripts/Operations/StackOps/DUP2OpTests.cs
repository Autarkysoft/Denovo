...
namespace Tests.Bitcoin.Blockchain.Scripts.Operations.StackOps
{
    public class DUP2OpTests
    {
        ...
        public void RunTest()
        {
            MockOpData data = new(FuncCallName.PeekCount, FuncCallName.PushMulti)
            {
                _itemCount = 2,
                _altItemCount = 0,
        ...
        {
            MockOpData data = new(FuncCallName.PeekCount)
            {
                _itemCount = 1,
            };

            OpTestCaseHelper.RunFailTest<DUP2Op>(data, Errors.NotEnoughStackItems);
        }
        ...
        public void Run_ItemCountOverflowTest()
        {
            ...
            OpTestCaseHelper.RunFailTest<DUP2Op>(data, Errors.StackItemCountOverflow);
        }
    }
}
