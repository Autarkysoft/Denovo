    ...
    public class SignatureTests
    {
        ...
        public static IEnumerable<object[]> GetReadSchnorrCases()
        {
            ...
            yield return new object[]
            {
                ...
                new Scalar8x32(Helper.HexToBytes("ec96b19cbaa1be6f7fc252d4cbaafbd0408c9de580996411e57a0c8ea3fe8ede"), out _),
        ...
        public void TryReadSchnorrTest(byte[] data, in Scalar8x32 expR, in Scalar8x32 expS, SigHashType expSH)
        {
        ...
        [Theory]
        [MemberData(nameof(GetReadSchnorrCases))]
        public void ToByteArraySchnorrTest(byte[] expBytes, in Scalar8x32 r, in Scalar8x32 s, SigHashType sh)
        {
