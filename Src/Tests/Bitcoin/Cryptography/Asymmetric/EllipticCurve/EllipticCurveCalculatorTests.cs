    ...
    public class EllipticCurveCalculatorTests
    {
        ...
        public static IEnumerable<object[]> GetSchnorrCases()
        {
            yield return new object[]
            {
                ...
                Helper.HexToBigInt("de2b58ff3b8b5d424a64529bfe10f87d35d5c3322a0c7f592cf30d4df9bbdd0c"),
                new Signature()
                {
        ...
        public void TrySignSchnorrTest(byte[] hash, byte[] key, BigInteger k, Signature expectedSig)
        {
            bool b = calc.TrySignSchnorr(hash, key, k, out Signature actualSig);
