...
namespace Autarkysoft.Bitcoin.Cryptography.EllipticCurve
{
    public readonly struct ModInv32Signed30
    {
        ...
        {
            Debug.Assert(Scalar8x32.GetOverflow(a) == 0);
        ...
        internal ModInv32Signed30(int[] arr)
        {
            v0 = arr[0]; v1 = arr[1]; v2 = arr[2]; v3 = arr[3]; v4 = arr[4]; v5 = arr[5]; v6 = arr[6]; v7 = arr[7]; v8 = arr[8];
        }

        const uint M30 = uint.MaxValue >> 2;
        internal readonly int v0, v1, v2, v3, v4, v5, v6, v7, v8;
