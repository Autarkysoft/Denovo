...
namespace Autarkysoft.Bitcoin.Cryptography.Asymmetric.EllipticCurve
{
    ...
    public sealed class SecP256k1 : IECurveFp
    {
        ...
        /// </summary>
        public BigInteger N => BigInteger.Parse("115792089237316195423570985008687907852837564279074904382605163141518161494337");
        /// <summary>
        /// Curve generator 
        ...
        /// </summary>
        public EllipticCurvePoint G => new EllipticCurvePoint(
